    ...
    return (
        <>
            <main className="lg:container lg:flex flex-col items-center justify-center min:h-screen h-screen py-16 lg:py-0">
                ...
                <section className="bg-white min:h-screen h-fit lg:h-fit border-2 border-white px-8 pt-8 pb-10 rounded-t-3xl lg:rounded-lg lg:grid lg:grid-cols-2 lg:gap-x-14 lg:w-[900px] shadow-sm drop-shadow-2xl">
                    <TipForm
